 ...
 * @array: Pointer  the first element of the [sub]array to search in
 * @low: Lower bound of the search range
 * @high: Upper bound  the search range
 ...
 *  by searching for value in  sorted array of integers.
 * @array: Pointer to the first element  the array to search in
